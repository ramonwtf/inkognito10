  ...
  return (
    <main className="container mt-5">
      ...
      <div className="row">
        ...
        <div className="back-noso col-7 shadow-lg ">
          ...
          <div className="back-noso col-7 shadow-lg mb-5 mt-5">
          ...
          <div className="col-5">
            <div className="nosotros-imagen">
              <img className="img-noso img-fluid mt-5 shadow-lg" src="/img/delivery.webp" alt="delivery"></img>
            </div>
