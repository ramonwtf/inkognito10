    ...
    <div className="ancho-con card mb-3">
      <div className="row g-0">
        <div className="col-md-4">
          <img src="/img/llamada.jpg" className="img-fluid rounded-start" alt="..."></img>
        </div>
        <div className="col-md-8">
          <div className="card-body ">
            <h2 className="card-title">Contactanos por via <strong className='envio' >WhatsApp</strong> </h2>
            <p className="card-text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quis animi ipsa libero omnis cum reprehenderit tempore quisquam, nihil, pariatur harum optio veritatis delectus sunt autem sit tenetur aperiam repellat. Fugit!</p>
            <ul>
              <li className="icon-color list-group-item mt-5"><i className="fa-brands fa-whatsapp fa-2xl"></i><span>1137623604</span></li>
            </ul>
